...
function Calendar({
	...
	return (
		<DayPicker
			...
			className={cn(
				// ⬇️ fixed here: replaced --spacing(8) with theme(spacing.8)
			...
			classNames={{
				...
				weekday: cn(
					"text-muted-foreground rounded-md flex-1 font-normal text-[0.925rem] select-none",
				...
				week_number: cn(
					"text-[0.925rem] select-none text-muted-foreground",
